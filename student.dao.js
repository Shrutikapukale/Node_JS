...
console.log("Format:insert into student(name,age,phno)values('abc',1,1) where id in (1,2,3)");
var insertStudent = function(obj,id) {
...
var ids=[1,2,3];
insertStudent({Name:"shruti","Age":25,"MoNo":9999},ids);
...
//o/p: select * from student where Name = Abc,Age = 20,MoNo = 999;
//////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////
console.log("insertUsingFunctionCalling:insert into student(Name,Age,MoNo)values ('shruti','25','9999' ) where id in (1,2,3);");
var insertUsingFunctionCalling=function(obj,ids){
	query="insert into student"+gnerateStringForkey(obj) +"values" + gnerateStringForValue(obj)+"where id in ("+ ids +");";
	console.log(query);
}
var ids=[1,2,3];
insertUsingFunctionCalling({Name: "Abc",Age:20 ,MoNo:999},ids);

//o/p: insert into student(Name,Age,MoNo)values(Abc,20,999)where id in (1,2,3);
/////////////////////////////////////////////////////////////////////////
